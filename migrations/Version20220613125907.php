 ...
 */
final class Version20220613125907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etude (id INT AUTO_INCREMENT NOT NULL, user_book_id INT NOT NULL, title VARCHAR(255) NOT NULL, acronyme VARCHAR(255) NOT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, resume LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_1DDEA9244EAFAD8B (user_book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
