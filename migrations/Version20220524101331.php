...
final class Version20220524101331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, projet_id INT DEFAULT NULL, text VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, type VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, location VARCHAR(255) DEFAULT NULL, INDEX IDX_B26681EB03A8386 (created_by_id), INDEX IDX_B26681EC18272 (projet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
