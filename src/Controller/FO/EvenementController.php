...
class EvenementController extends AbstractController
{
    ...
    {
        return $this->render('projets/user_projets_events.html.twig', [
    ...
    public function usersEvents(Request $request, SocieteUserRepository $societeUserRepository)
    {
        ...
        return $this->render('projets/users_projets_events.html.twig', [
    ...
    /**
     * @Route("/users-evenements", name="app_fo_users_projets_events")
     */
    public function usersProjetsEvents(Request $request, SocieteUserRepository $societeUserRepository)
    {
