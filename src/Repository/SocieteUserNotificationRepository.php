...
/**
 * @method SocieteUserNotification|null find($id, $lockMode = null, $lockVersion = null)
 * @method SocieteUserNotification|null findOneBy(array $criteria, array $orderBy = null)
 * @method SocieteUserNotification[]    findAll()
 * @method SocieteUserNotification[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class SocieteUserNotificationRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, SocieteUserNotification::class);
    }

    /**
     * @return SocieteUserNotification[]
     */
    ...
    public function acknowledgeAllFor(SocieteUser $societeUser, array $ids): void
    {
        $this->createQueryBuilder('notification')
            ->update(SocieteUserNotification::class, 'notification')
