...
$(() => {
     ...
     */
    const apiGetUserNotifications = () => fetch(`/corp/api/user-notifications/${userContext.societeUserId}`);
     ...
     */
    const apiPostUserNotifications = acknowledgeIds => fetch(`/corp/api/user-notifications/${userContext.societeUserId}`, {
        method: 'post',
        headers: {
